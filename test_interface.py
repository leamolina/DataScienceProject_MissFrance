...
def accueil():
    ...
    st.video(chemin_video_lea, format="video/mp4", start_time=0)
...
def page_un():
    ...
    with open(f'/Users/LEAMOLINA1/Desktop/M1/S2/Projet ML : DataScience/Projet/COHEN_Anaelle_MOLINA_Lea/sources/timeline.json', "r") as f:
        data = f.read()
