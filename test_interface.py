...
def accueil():
    ...
    st.image(chemin_logo_ana, use_column_width=False, output_format='auto', width=100, clamp=False, channels='RGB')
    st.write("Bienvenu dans notre projet  \nNous allons essayer de prédire la Miss France 2025")

    st.audio(chemin_audio_ana)
...
st.sidebar.image(chemin_logo_ana, width=100)
st.sidebar.markdown(
